            ...
            if self.multitry > 1:
                ...
                if run_snooker:
                    ...
                    if not np.isfinite(total_proposed_logp) and not np.isfinite(total_old_logp):
                        warnings.warn("both total_proposed_logp and total_old_logp are infinite!!!")
